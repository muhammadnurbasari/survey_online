          ...
          <div class="row no-gutters">
            <div class="col-md-6">
              ...
              <ul class="navbar-nav bg-gradient" id="accordionSidebar">
                <!-- change Photo -->
                <form method="post" action="<?= base_url('admin/update_photo'); ?>" enctype="multipart/form-data">
                  <li class="nav-item">
                      <img src="<?= base_url('assets/img/') .$user['image']; ?>" class="card-img mt-1 ml-1 rounded-sm">
                        ...
                        <button class="btn btn-primary mt-2 ml-1 btn-block mb-2" type="submit">Change Photo</button>
                  </li>
                </form>
              </ul>
            </div>
