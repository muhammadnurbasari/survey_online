...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2019 at 02:00 PM
...
--
-- Table structure for table `surveyor_access_menu`
--

CREATE TABLE `surveyor_access_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `surveyor_access_menu`
--

INSERT INTO `surveyor_access_menu` (`id`, `menu_id`, `role_id`) VALUES
(2, 1, 1),
(3, 2, 1),
(4, 2, 2);
...
--
-- Table structure for table `surveyor_menu`
--

CREATE TABLE `surveyor_menu` (
  `menu_id` int(11) NOT NULL,
  `menu` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `surveyor_menu`
--

INSERT INTO `surveyor_menu` (`menu_id`, `menu`) VALUES
(1, 'Administrator'),
(2, 'Surveyor');
...
--
-- Table structure for table `surveyor_sub_menu`
--

CREATE TABLE `surveyor_sub_menu` (
  `id` int(11) NOT NULL,
  `menu_id` int(11) NOT NULL,
...
--
-- Dumping data for table `surveyor_sub_menu`
--

INSERT INTO `surveyor_sub_menu` (`id`, `menu_id`, `icon`, `title`, `url`) VALUES
(1, 1, 'fas fa-fw fa-tachometer-alt', 'Dashboard', 'admin'),
(2, 2, 'fas fa-fw fa-calendar-plus', 'Create Angket', 'user/create_angket'),
(3, 2, 'fas fa-fw fa-sticky-note', 'Daftar Angket', 'angket');
...
--
-- Indexes for table `surveyor_access_menu`
--
ALTER TABLE `surveyor_access_menu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `menu_id` (`menu_id`),
  ADD KEY `role_id` (`role_id`);

--
-- Indexes for table `surveyor_menu`
--
ALTER TABLE `surveyor_menu`
...
--
-- Indexes for table `surveyor_sub_menu`
--
ALTER TABLE `surveyor_sub_menu`
  ADD PRIMARY KEY (`id`),
  ADD KEY `menu_id` (`menu_id`);
...
--
ALTER TABLE `nilai_detail`
  MODIFY `id_nilai_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
-- AUTO_INCREMENT for table `surveyor_access_menu`
--
ALTER TABLE `surveyor_access_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `surveyor_menu`
--
ALTER TABLE `surveyor_menu`
...
--
-- AUTO_INCREMENT for table `surveyor_sub_menu`
--
ALTER TABLE `surveyor_sub_menu`
...
--
-- Constraints for table `surveyor_access_menu`
--
ALTER TABLE `surveyor_access_menu`
  ADD CONSTRAINT `surveyor_access_menu_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `surveyor_menu` (`menu_id`),
  ADD CONSTRAINT `surveyor_access_menu_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `surveyor_role` (`role_id`);

--
-- Constraints for table `surveyor_sub_menu`
--
ALTER TABLE `surveyor_sub_menu`
  ADD CONSTRAINT `surveyor_sub_menu_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `surveyor_menu` (`menu_id`);
